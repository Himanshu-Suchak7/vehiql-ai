...
export async function processCarImageWithAI(file) {
    try {
      ...
      1. Make (manufacturer)
      2. Model
      3. Year (approximately) (important: must be a string containing 4-digit year (e.g., "2025") )
      4. Color
      5. Body type (SUV, Sedan, Hatchback, etc.)
      6. Mileage
      7. Fuel type (your best guess)
      8. Transmission type (your best guess)
      9. Price (your best guess and must be in USD, no range and no $ symbol appended also must be in string (e.g., "14500"))
    ...
    try {
        ...
        const car = await db.cars.create({
            data: {
                ...
                seating_capacity: carData.seats,
