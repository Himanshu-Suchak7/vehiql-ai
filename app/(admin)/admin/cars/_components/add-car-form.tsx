...
const AddCarForm = () => {
	...
	const carFormSchema = z.object({
		...
		description: z.string().min(10, "Description must be 10 words long"),
	...
	const processWithAi = async () => {
		...
		await processImageFn(uploadedAiImages);
	};
	...
	}, [processImageResult, setValue, uploadedAiImages]);
	...
	useEffect(() => {
		console.log("addCarResult:", addCarResult);
	...
	async function onSubmit(data) {
		...
		const result = await addCarFn({
			carData,
			images: uploadedImages,
		});
		console.log("addCarFn result:", result);
	}
						...
						<CardContent>
							<form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
								<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
									...
									<div className="space-y-2">
										<Label htmlFor="bodyType">Fuel Type</Label>
										<Select
				...
				<TabsContent value="ai" className="mt-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Upload an image of a car and let Gemini AI extracts its details
								for you.
							</CardDescription>
						</CardHeader>
						<CardContent>
